    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="<?php echo base_url(); ?>" class="logo">
                ...
                <span class="logo-mini"><?php echo config_item('app_name_small') ?></span>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; <?php echo date('Y'); ?> Developed by <a target="_blank" href="https://www.linkedin.com/in/adam-prasetia-449405109/?originalSubdomain=id">Adam Prasetia</a>
