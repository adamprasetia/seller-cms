...
class Category extends MY_Controller {
	...
	public function index()
	{
		...
		$data['content'] 	= $this->load->view('contents/category_view', $content_view, TRUE);
	...
	public function detail($id)
	{
		...
		echo $this->load->view('contents/detail_category_view', $content_view, true);
	}
	...
	public function add()
	{
		...
		if ($this->form_validation->run()===FALSE) {
			$data['content'] = $this->load->view('contents/form_category_view', [
				'action'=>base_url('category/add').get_query_string()
			],true);
	...
	public function edit($id='')
	{
		...
		if ($this->form_validation->run()===FALSE) {
			...
			$content_view['action'] = base_url('category/edit/'.$id).get_query_string();
			$data['content'] = $this->load->view('contents/form_category_view',$content_view,true);
